...
@store1.employees.create(first_name: "Alisson", last_name: "Gray", hourly_rate: 39)
@store1.employees.create(first_name: "Cassandra", last_name: "Jackson", hourly_rate: 40)
@store1.employees.create(first_name: "Andrew", last_name: "Bernard", hourly_rate: 30)

@store2.employees.create(first_name: "Sara", last_name: "Collins", hourly_rate: 60)
@store2.employees.create(first_name: "Amanda", last_name: "Robinson", hourly_rate: 34)
...
@store2.employees.create(first_name: "Creed", last_name: "Bratton", hourly_rate: 28)